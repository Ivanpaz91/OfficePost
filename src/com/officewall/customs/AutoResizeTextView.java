...
public class AutoResizeTextView extends TypefaceTextView {
    ...
    public void resizeText(int width, int height) {
        ...
        if (mAddEllipsis && targetTextSize == mMinTextSize && textHeight > height) {
            ...
            // Draw using a static layout
            StaticLayout layout = new StaticLayout(text, paint, width, Alignment.ALIGN_NORMAL,
    ...
    private int getTextHeight(CharSequence source, TextPaint paint, int width, float textSize) {
        ...
        StaticLayout layout = new StaticLayout(source, paintCopy, width, Alignment.ALIGN_NORMAL,
