...
public class PullToRefreshListView extends ListView {
    ...
    // private SimpleDateFormat lastUpdatedDateFormat = new
    ...
    private void init() {
        ...
        headerContainer = (LinearLayout)LayoutInflater.from(getContext()).inflate(
                R.layout.view_pull_to_refresh, null);
        header = (RelativeLayout)headerContainer.findViewById(R.id.rl_ptr_id_header);
        text = (TextView)header.findViewById(R.id.tv_ptr_text);
        // lastUpdatedTextView =
        // (TextView)header.findViewById(R.id.tv_ptr_last_update);
        image = (ImageView)header.findViewById(R.id.iv_ptr_arrow);
        // spinner = (ProgressBar)header.findViewById(R.id.pb_ptr_spinner);

        pullToRefreshText = getContext().getString(R.string.strPullToRefresh);
        releaseToRefreshText = getContext().getString(R.string.strReleaseToRefresh);
