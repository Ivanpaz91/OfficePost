...
import com.officewall.activities.R.styleable;

/**
 * Subclass of {@link EditText} that supports the <code>customTypeface</code>
 * attribute from XML.
 */
    ...
    public TypefaceEditText(final Context context, final AttributeSet attrs, final int defStyle) {
        ...
        if (array != null) {
            final String typefaceAssetPath = array
                    .getString(styleable.TypefaceTextView_customTypeface);
